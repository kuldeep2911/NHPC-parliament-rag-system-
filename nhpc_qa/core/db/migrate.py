...
already-applied migration is caught rather than silently ignored.
    ...
    python -m nhpc_qa.core.db.migrate            # apply pending
    python -m nhpc_qa.core.db.migrate --status   # show applied/pending, no writes
...
# All migrations now live in ONE lineage at the repo root, not under a phase package.
