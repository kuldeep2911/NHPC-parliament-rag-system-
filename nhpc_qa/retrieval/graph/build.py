...
from nhpc_qa.retrieval.graph import nodes
from nhpc_qa.retrieval.graph.state import QueryState
from nhpc_qa.retrieval.search.fuse import should_widen
...
def build_graph(deps):
    ...
    if cfg.generation_enabled:
        from nhpc_qa.retrieval.generation.draft import generate_draft   # local: no import at all when off
