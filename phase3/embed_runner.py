...
Generate embeddings for sub_questions.
    ...
    python -m phase3.embed_runner                 # embed rows that have no vector
    ...
    python -m phase3.embed_runner --dry-run       # show what would be embedded
    python -m phase3.embed_runner --limit 10
