...
Phase-3 loader: every parsed.json -> Postgres.
    ...
    python -m phase3.loader --limit 5           # load the first 5
    python -m phase3.loader --only 8773         # load specific question folders
    python -m phase3.loader                     # load everything
    python -m phase3.loader --force             # re-load (and mark for re-embed)
...
from .config import Phase3Config, load_dotenv, session_year
