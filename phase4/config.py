...
from phase2.config import load_dotenv                     # noqa: F401 (re-exported)
from phase3.config import Phase3Config, _redact_dsn
...
class Phase4Config(Phase3Config):
    ...
    def langfuse_keys(self):
        ...
        Required by phase2.trace.langfuse_client.LangfuseTracer, which this config is
