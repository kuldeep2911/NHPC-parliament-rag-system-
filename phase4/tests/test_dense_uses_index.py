...
(imported from phase4.retrieval.dense, not a copy) and fails if the plan is not an
Index Scan on idx_sub_questions_embedding_hnsw.

    python -m phase4.tests.test_dense_uses_index
"""
...
from phase4.retrieval import dense
...
def main():
    ...
    with connect(cfg) as conn:
        ...
        print("=" * 74)
        print("EXPLAIN of the REAL dense query (phase4.retrieval.dense.build_sql)")
        print("=" * 74)
        print(_short(plan))
        print()
        if used_index:
